...
## 目录
- [服务层接口](#服务层接口)
  - [1. 文件语法解析模块](#1-文件语法解析模块)
  - [2. 函数检查模块](#2-函数检查模块)
  - [3. 总检查模块](#3-总检查模块)
  - [4. 函数白名单筛选模块](#4-函数白名单筛选模块)
  - [5. 任务取消模块](#5-任务取消模块)
  - [6. 工作区跳转模块](#6-工作区跳转模块)
  - [7. 设置配置读取模块](#7-设置配置读取模块)
- [数据交互层接口(TS部分)](#数据交互层接口ts部分)
  - [8. 数据库存储模块](#8-数据库存储模块)
  - [9. 数据库读取模块](#9-数据库读取模块)
- [数据交互层接口(CPP部分)](#数据交互层接口cpp部分)
  - [10. 数据库存储模块(CPP)](#10-数据库存储模块cpp)
  - [11. 数据库读取模块(CPP)](#11-数据库读取模块cpp)
