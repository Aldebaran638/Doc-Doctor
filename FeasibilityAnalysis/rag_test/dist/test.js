...
import { findRelatedFunctionsOnline } from "./utils/online-rag.js";
import { findRelatedFunctionsOffline } from "./utils/offline-rag.js";
/**
 * 测试用的C++函数示例
 */
const testFunctions = {
 ...
 * 测试离线版本RAG
 */
async function testOfflineRag(inputFunction) {
    try {
 ...
 * 测试网络版本RAG
 */
async function testOnlineRag(inputFunction) {
    try {
        const startTime = Date.now();
